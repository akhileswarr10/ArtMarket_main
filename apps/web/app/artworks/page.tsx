...
export default function ArtworksPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['artworks', session?.user?.id, search, medium, style, skip],
  ...
  const hasFilters = search || medium || style
      ...
      <main className="container mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6">
          ...
          <div className="flex gap-2">
            <select
              value={medium}
              onChange={e => { setMedium(e.target.value); setSkip(0) }}
            ...
            <select
              value={style}
              onChange={e => { setStyle(e.target.value); setSkip(0) }}
              className="px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm text-white outline-none focus:border-indigo-500/40 transition-all appearance-none cursor-pointer min-w-[120px]"
            >
              ...
              {artworks.map(artwork => {
                ...
                return (
                  <motion.div
                    ...
                    className="group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-indigo-500/30 hover:shadow-lg hover:shadow-indigo-500/5 transition-all cursor-pointer"
