      ...
      <div className="max-w-5xl mx-auto print:hidden">
        <header className="mb-12">
          <button 
            ...
            className="flex items-center gap-2 text-ink-secondary hover:text-ink transition-colors mb-6 group"
          >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-display text-4xl font-bold text-ink">Sales & Earnings</h1>
                <p className="text-ink-secondary">Track your masterpiece acquisitions</p>
              </div>
            </div>

            {/* Summary Cards */}
            <div className="flex gap-4">
               <div className="bg-surface border border-border-subtle rounded-2xl shadow-card p-4 min-w-[160px]">
                  <p className="text-xs text-ink-secondary uppercase font-bold tracking-widest mb-1">Total Earned</p>
                  <p className="text-2xl font-mono font-semibold text-emerald">£{totalEarnings.toLocaleString()}</p>
               </div>
               <div className="bg-surface border border-border-subtle rounded-2xl shadow-card p-4 min-w-[140px]">
                  <p className="text-xs text-ink-secondary uppercase font-bold tracking-widest mb-1">Items Sold</p>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-surface/60 rounded-[2.5rem] border border-border">
            ...
            <h3 className="font-display text-xl font-semibold text-ink mb-2">No sales yet</h3>
            <p className="text-ink-secondary mb-8">Maintain your gallery to attract collectors</p>
          </div>
        ) : (
          ...
          >
            ...
            >
              ...
              <div className="p-6 border-b border-border-subtle flex items-center justify-between bg-surface/30">
                <div>
                  <h2 className="font-display text-xl font-semibold text-ink">Sale Details</h2>
                  <p className="text-xs text-ink-secondary mt-1 uppercase tracking-widest font-bold">Order #{selectedOrder.id.slice(0, 12)}</p>
                </div>
                <button 
              ...
              <div className="p-8 space-y-8 max-h-[70vh] overflow-y-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h4 className="text-[11px] font-semibold text-ink-muted uppercase tracking-widest">Fullfillment</h4>
                    <div className="bg-surface/60 rounded-2xl p-4 border border-border-subtle flex items-center gap-3">
                       ...
                       <div>
                         ...
                         <p className="text-[10px] text-ink-secondary">Awaiting shipping label</p>
                       </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <h4 className="text-[11px] font-semibold text-ink-muted uppercase tracking-widest">Purchased By</h4>
                    <div className="bg-surface/60 rounded-2xl p-4 border border-border-subtle flex items-center gap-3">
                       <div className="w-10 h-10 rounded-xl bg-gold-muted flex items-center justify-center text-gold-400">
                         <UserIcon className="w-5 h-5" />
                       </div>
                       <div>
                         <p className="text-sm font-bold text-ink">Verified Collector</p>
                         <p className="text-[10px] text-ink-secondary">Order ID: {selectedOrder.buyer_id.slice(0, 8)}...</p>
                       </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface/60 rounded-[2rem] p-6 border border-border-subtle space-y-3">
                   ...
                   <div className="flex justify-between text-sm text-ink-secondary">
                     ...
                     <span className="text-ink-secondary text-[10px] font-bold uppercase tracking-widest">£0.00 (Promotion)</span>
                   </div>
                   <div className="pt-3 border-t border-border flex justify-between items-baseline">
                     <span className="font-bold text-ink">Your Earnings</span>
              ...
              <div className="p-6 bg-surface/30 border-t border-border-subtle flex gap-3">
                ...
                <button 
                  ...
                  className="px-6 bg-surface/60 hover:bg-surface-raised/70 text-ink rounded-2xl transition-all font-bold text-sm"
                >
                  View Details
                </button>
              </div>
